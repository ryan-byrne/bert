...
export default function PowerSanders({ update }) {
  return (
    <Training id="power-sanders" >
      ...
      <Topic name="Additional Resources" topicKey={5}>
        <h1>Videos</h1>
        <iframe className="w-100" height="315" src="https://www.youtube.com/embed/TZzZcNNOD28" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        <iframe className="w-100" height="315" src="https://www.youtube.com/embed/x1FehVIkq_k" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        <iframe className="w-100" height="315" src="https://www.youtube.com/embed/oj8FMNLoKEA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        <iframe className="w-100" height="315" src="https://www.youtube.com/embed/eUo5UgRzTwE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        <h1>Links</h1>
        <ul>
          <li><a href="https://www.powertoolinstitute.com/pti-pages/tools/Sanders.asp">Power Tool Institute</a></li>
