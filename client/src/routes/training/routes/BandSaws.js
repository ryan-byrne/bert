...
export default function BandSaws({ update }) {
  return (
    <Training id="band-saws" >
      ...
      <Topic name="Additional Resources" topicKey={5}>
        <h1>Videos</h1>
        <iframe className="w-100" height="315" src="https://www.youtube.com/embed/cQqq3rAZ4PI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        <h1>Links</h1>
        <ul>
          <li><a href="https://www.powertoolinstitute.com/pti-pages/tools/Band-Saws.asp">Power Tool Institute</a></li>
          <li><a href="https://www.ehs.harvard.edu/sites/default/files/machine_shop_safety_osha_guidance_band_saw.pdf">Harvard EHS</a></li>
        </ul>
      </Topic>
